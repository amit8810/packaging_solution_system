...
import { Box, PackingMaterial } from '../models';
...
const boxes = [
    ...
    {
        sku: 'BX10014',
        name: 'Flat Mailer Large Heavy Duty',
        length: 18,
        width: 12,
        height: 1.5,
        strength: 'double-wall',
    ...
    {
        sku: 'BX10015',
        name: 'Standard Box Small Heavy Duty',
        length: 10,
        width: 8,
        height: 8,
        strength: 'double-wall',
    ...
    {
        sku: 'BX10017',
        name: 'Mailing Tube Small Heavy Duty',
        length: 18,
        width: 3,
        height: 3,
        strength: 'double-wall',
    ...
    {
        sku: 'BX10019',
        name: 'Standard Box Medium Heavy Duty',
        length: 15,
        width: 12,
        height: 10,
        strength: 'triple-wall',
    ...
    {
        sku: 'BX10020',
        name: 'Flat Mailer Small Heavy Duty',
        length: 10,
        width: 7,
        height: 0.75,
        strength: 'double-wall',
    ...
    {
        sku: 'BX10022',
        name: 'Mailing Tube Large Heavy Duty',
        length: 36,
        width: 4,
        height: 5,
        strength: 'triple-wall',
    ...
    {
        sku: 'BX10024',
        name: 'Flat Mailer Medium Heavy Duty',
        length: 14,
        width: 10,
        height: 1,
        strength: 'double-wall',
